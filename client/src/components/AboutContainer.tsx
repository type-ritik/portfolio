  ...
  return (
    ...
    >
      <div className="w-full bg-dark-purple-blur border border-light-yellow rounded-2xl p-8! text-white">
        {/* TITLE */}
        <h1 className="text-5xl! not-md:text-3xl! text-light-yellow text-center font-bold mb-10! not-md:mb-6!">
          About Me
        </h1>
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div className="space-y-5 text-gray-200">
            <p className="not-md:text-sm! text-lg!">
          ...
          <div className="bg-[#1a1238] border border-light-purple rounded-xl p-6! flex flex-col justify-center space-y-4">
            <div>
              ...
              <p className="text-gray-300 not-md:text-sm!">
                Backend Engineering
              </p>
            </div>
