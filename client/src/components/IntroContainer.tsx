...
function IntroContainer() {
  ...
  const handleDownloadResume = () => {
    const pdfUrl = "https://drive.google.com/file/d/11snLJNjmguSjM0WORDDaEN2y4Mxr9Zto/view?usp=sharing";
  ...
  return (
    <div
      id="home"
      className="flex w-full -mt-20! h-screen justify-center items-center"
    >
      <div className="w-full h-80 not-md:h-1/2 flex bg-dark-purple-blur not-md:flex-col rounded-2xl border border-light-yellow! justify-center">
        <div className="w-3/5 flex flex-col not-md:h-full justify-center not-md:w-full gap-4">
          <h1 className="text-6xl! not-md:text-3xl! not-md:pt-3! gap-3 justify-center items-center leading-tight font-bold flex ">
            <span className="text-light-yellow">Hi, I&apos;m</span>{" "}
            <span className="text-dark-orange">{name}</span>
          </h1>
          <div className="flex justify-between items-center text-xl not-md:text-base not-md:flex-col text-white gap-0">
          ...
          <div className="flex justify-center">
            <div className="btn-container not-md:gap-6 not-md:flex-col not-md:w-full not-md:pb-2! w-4/5 flex justify-between items-center my-4!">
              ...
              <button
                ...
                className="w-2/5 hover:ease-in-out not-md:w-[90%] hover:border-[#5741d9]  transition-all shadow-xl/20 hover:shadow-white  rounded-full py-6! text-sm font-semibold border cursor-pointer border-[#655ae0] bg-gray-600 text-white"
              >
                {"GitHub".toUpperCase()}
              </button>
            </div>
